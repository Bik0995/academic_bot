...
class MladiinfoScraper(BaseScraper):
    BASE_URL = "https://www.mladiinfo.eu/"
    ...
    async def scrape(self):
        ...
        print(f"Mladiinfo : {len(title_links)} liens de titre trouvés")
        ...
        print(f"Mladiinfo : {len(opportunities)} offres construites")
